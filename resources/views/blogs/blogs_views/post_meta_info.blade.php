<!-- Title -->
<h1>
    <a href="/blogs/entry/{{$post[\App\Utilities\Constants::FLD_POSTS_POST_ID]}}">{{$post[\App\Utilities\Constants::FLD_POSTS_TITLE]}}</a>
</h1>
...
<p><span class="glyphicon glyphicon-time"></span>
    ...
    &nbsp; &nbsp;<span>
        <a href="{{$post_unlike_url}}/{{$post[\App\Utilities\Constants::FLD_POSTS_POST_ID]}}" id="blog-down-vote-icon">
        ...
        <a href="{{$post_like_url}}/{{$post[\App\Utilities\Constants::FLD_POSTS_POST_ID]}}" id="blog-up-vote-icon">
