            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="text-center">
                        ...
                        <img src="{{ asset('images/' . $user->profile_picture)}}" class="avatar img-circle"
                             onerror=this.src="/images/profile/UserDefault.png"; width="200" height="200" alt="avatar">
                ...
                <div class="col-md-9 personal-info">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input name="FirstName" class="form-control"
                                   value="{{isset($user->first_name) ? $user->first_name: "" }}" type="text">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input name="LastName" class="form-control"
                                   value="{{isset($user->last_name) ? $user->last_name: "" }}" type="text">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input style="background-color:white;" class="form-control" name="birthdate"
                                   value="{{isset($user->birthdate) ? $user->birthdate: "" }}" type="date"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input name="{{ \App\Utilities\Constants::FLD_USERS_CODEFORCES_HANDLE }}"
                                   class="form-control"
                                   value="{{isset($handle['0']['original']['pivot_handle']) ? $handle['0']['original']['pivot_handle']: "" }}"
                                   type="text">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input name="{{ \App\Utilities\Constants::FLD_USERS_UVA_HANDLE }}" class="form-control"
                                   value="{{isset($handle['1']['original']['pivot_handle']) ? $handle['1']['original']['pivot_handle']: "" }}"
                                   type="text">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input name="{{ \App\Utilities\Constants::FLD_USERS_LIVE_ARCHIVE_HANDLE }}"
                                   class="form-control"
                                   value="{{isset($handle['2']['original']['pivot_handle']) ? $handle['2']['original']['pivot_handle']: "" }}"
                                   type="text">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            ...
                            <span></span>
                            <a href="{{ route(\App\Utilities\Constants::ROUTES_PROFILE, $user[\App\Utilities\Constants::FLD_USERS_USERNAME]) }}">
...
<div class="container">
 ...
 <hr>
	...
	@endsection
>>>>>>> 79f8241fa31396f62a4cd9cc00a91c9c683b7ea3
