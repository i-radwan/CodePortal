        ...
        <div class="row">
            <div class="col-md-8">
                <div class="panel panel-default">
                    <div class="panel-heading">Profile <a class=" pull-right btn-sm RbtnMargin" href="/status/abzo/">History
                            of submissions</a></div>
                    ...
                    @endif
                    <div class="container">
                        <br> <img class="thumbnail img-responsive" src="/images/profile/UserDefault.png"
                                  class="img-rounded" alt="Cinque Terre" width="200" height="240">
                    </div>
