        ...
        <tr>
            ...
            @if($isOwner)
                <td class="text-center">
                    ...
                    {{--Remove member--}}
                    @include('components.action_form', ['url' => route(\App\Utilities\Constants::ROUTES_GROUPS_MEMBER_REMOVE, [$groupID, $memberUsername]), 'method' => 'DELETE', 'confirm' => true, 'confirmMsg' => "'Are you sure want to remove this member? This action cannot be undone!'", 'btnIDs' => "testing-remove-member-$memberID", 'btnClasses' => 'btn btn-link text-dark', 'btnTxt' => 'Remove'])
